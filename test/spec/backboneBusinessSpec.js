    ...
    describe('and mixes in Backbone.Buisness with Backbone.View.extend', function () {
      ...
      describe('with a facts parameter that is a Backbone.Model', function () {
        beforeEach(function () {
          ...
          ViewWithBusiness = View.extend(Backbone.Business({viewClass : View, businessRules : {}, facts : new Facts({fact1:true})})); //buisness rules are empty - later on we'll inject them
        });
